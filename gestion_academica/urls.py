...
from .views import alumnos, asistencias, calificaciones, cargos, comunicados, profesores, planilla_docente, infraestructura, materias
...
urlpatterns = [
    ...
    # --- DOMINIO: MATERIAS ---
    path('materias/', materias.GestionMateriasView.as_view(), name='gestion_materias'),
]